	...
	<div id="container">
		...
		<div class="content">
			...
			<div class="forms">
				...
				<form class="bookAdd" action="issu_book"
					onsubmit="return checkqty(this);" method="POST" name="theForm">
					...
					<table class="tab" style="border-color: black; color: black"
						...
						<tr>
							<td>Copies:</td>
							<td><input type="text" name="copies" value="<%=c2%>"
								required></td>
						</tr>
						<tr>
							<td>qty:</td>
						...
						<tr>
							<td>return date:</td>
							<td><input id="datepicker" type="text" name="date" required /></td>
						</tr>
						<tr></tr>
						<tr>
							<td></td>
