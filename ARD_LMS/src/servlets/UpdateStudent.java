...
public class UpdateStudent extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "UPDATE user SET username='"+Username+"',password='"+Password+"',fname='"+FirstName+"',lname='"+LastName+"',dob='" +dob+"',nic='"+NIC+"',phone='"+phone+"',email='"+Email+"'ORDER BY uid DESC LIMIT 1";
